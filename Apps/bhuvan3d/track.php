				...
				<tr>
					<td width="42%" height="60px" valign="top">
						<a href='http://bhuvan.nrsc.gov.in/bhuvan/'>
							<img border=0  src="img/bhuvan_viewer3t1.png" style='float:left; padding-left:5px;  vertical-align:middle'>
						</a>
					</td>               
...
<table cellpadding="0px" cellspacing="0px" border="0" style="float:right; padding-top:2px; vertical-align:middle; height:100%;font-family: Arial; font-size: 14px; color: white">
	...
	<!--			-->
	<td>&nbsp;|&nbsp;<b><a href="#" id="lookd" style="font-family: Arial; font-size: 12px; color: white">Look Down</a></b></td>
...
<script id="cesium_sandcastle_script" type="text/javascript" src="js/track.js"> </script>
<?php
$browser = getBrowser();
function getBrowser()
{
