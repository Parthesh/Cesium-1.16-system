...
define([
        ...
        '../Animation/AnimationViewModel',
		   '../Navigation/Navigation', //bhuvan 25-5
        '../Navigation/NavigationViewModel', //bhuvan 25-5
        ...
        Animation,
        AnimationViewModel,
		 Navigation, //bhuvan 25-5
		 NavigationViewModel, //bhuvan 25-5
        BaseLayerPicker,
...
Either specify options.terrainProvider instead or set options.baseLayerPicker to true.');
  ...
  //Geocoder //bhuvan search & home button not needed
        // Geocoder
        /*
...
//Navigation  //bhuvan 25-5
        ...
        if (typeof options.navigation === 'undefined' || options.navigation !== false) {
            ...
            navigation = new Navigation(navigationContainer, new NavigationViewModel(cesiumWidget.canvas, cesiumWidget.scene.camera));
        ...
        this._toolbar = toolbar;
           // this._homeButton = homeButton; //bhuvan
        //this._sceneModePicker = sceneModePicker;
        this._baseLayerPicker = baseLayerPicker;
        this._animation = animation;
		this._navigation = navigation; //bhuvan 25-5
        this._timeline = timeline;
        this._fullscreenButton = fullscreenButton;
       // this._geocoder = geocoder; bhuvan
 ...
 /** //bhuvan 25-5
    ...
    Viewer.prototype.resize = function() {
        ...
        var timeline = this._timeline;
      	  var navigationExists = defined(viewer._navigation); //bhuvan 25-5
        var animationContainer;
			var navigationContainer; //bhuvan 25-5
 ...
 var navigationWidth = 0; //bhuvan 25-5
        if (navigationExists) {  //bhuvan 25-5
            var lastWidth = viewer._lastWidth;
            navigationContainer = viewer._navigation.container;
			if (width > 900) {
                if (lastWidth <= 900) {
                    navigationWidth = 169;
 ...
 Viewer.prototype.render = function() {
		if(defined(this._navigation)) { //bhuvan 25-5
